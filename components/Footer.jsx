  ...
  return (
    <footer className="site-footer" id="contact">
      <div className="container footer-main-grid">
        ...
        <div className="footer-brand-col">
          ...
          <p className="footer-clinic-desc">
            {content?.footerClinicDesc || 'Expert care for TMJ/TMD disorders using advanced diagnostics and non-invasive treatments to restore comfort and jaw function. Led by Dr. Ashwin in Kozhikode.'}
          </p>
          <div className="footer-social-icons">
            <a href={content?.footerFacebook || 'https://facebook.com'} target="_blank" rel="noopener noreferrer" className="social-circle-btn social-facebook" aria-label="Facebook">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path>
              </svg>
            </a>
            <a href={content?.footerInstagram || 'https://instagram.com'} target="_blank" rel="noopener noreferrer" className="social-circle-btn social-instagram" aria-label="Instagram">
            ...
            <a href={content?.footerYoutube || 'https://youtube.com'} target="_blank" rel="noopener noreferrer" className="social-circle-btn social-youtube" aria-label="YouTube">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
            ...
            <a href={content?.footerLinkedin || 'https://linkedin.com'} target="_blank" rel="noopener noreferrer" className="social-circle-btn social-linkedin" aria-label="LinkedIn">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
      ...
      <div className="container footer-copyright-bar">
        <p>{content?.footerCopyright || "© 2026 Dr. Ashwin's TMD Clinic. All rights reserved."}</p>
      </div>
    </footer>
  );
}
