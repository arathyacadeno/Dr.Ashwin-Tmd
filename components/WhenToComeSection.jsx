      ...
      <div className="tmd-when-grid">
        ...
        <div className="tmd-when-col-left">
          <div className="when-checklist">
            <div className="when-check-pill">
              <div className="check-pill-icon">✓</div>
              <span>Pain or discomfort that has lasted more than two or three weeks.</span>
            </div>
            <div className="when-check-pill">
              <div className="check-pill-icon">✓</div>
              <span>Clicking, popping, or grating sounds accompanied by any pain or tightness.</span>
            </div>
            <div className="when-check-pill">
              <div className="check-pill-icon">✓</div>
              <span>Your jaw catches, locks, or feels like it won&apos;t open all the way.</span>
            </div>
            <div className="when-check-pill">
              <div className="check-pill-icon">✓</div>
              <span>Headaches, ear symptoms, or neck pain that other doctors haven&apos;t been able to explain.</span>
            </div>
            <div className="when-check-pill">
              <div className="check-pill-icon">✓</div>
              <span>Waking up every morning with a tight, tired, or aching jaw.</span>
            </div>
          </div>
        </div>
        ...
        <div className="tmd-when-col-right">
          <div className="tmd-consult-card">
            ...
            <div className="consult-action-card">
              ...
              <Link href="/contact" className="consult-action-btn">
