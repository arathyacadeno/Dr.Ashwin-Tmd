...
export const BusiestJointSection = () => {
  ...
  useEffect(() => {
    ...
    if (!section || !allWords.length) return;
    ...
    const handleScroll = () => {
      ...
      const activeCount = Math.floor(progress * (allWords.length + 2));
        ...
        <div className="tmd-joint-col-visual">
          <div className="tmj-anatomy-card">
            ...
            <div className="anatomy-diagram-wrap">
              <svg viewBox="0 0 380 260" width="100%" height="auto" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ maxWidth: '360px' }}>
                {/* Temporal Bone Fossa (Upper Cranial Base) */}
                <path d="M40 80 Q100 80 140 82 Q180 84 210 100 Q240 115 280 115 Q330 115 350 115" stroke="#94A3B8" strokeWidth="3" strokeLinecap="round" fill="none" />
                <path d="M40 80 L350 80 L350 115 Q330 115 280 115 Q240 115 210 100 Q180 84 140 82 Q100 80 40 80 Z" fill="#E2E8F0" opacity="0.6" />
                <text x="50" y="65" fontFamily="'Plus Jakarta Sans', sans-serif" fontSize="11" fontWeight="600" fill="#64748B">Temporal bone</text>
                <line x1="125" y1="68" x2="150" y2="82" stroke="#94A3B8" strokeWidth="1.2" strokeDasharray="2 2" />

                {/* Articular Disc (Cushioning Disc) - Highlighted in Gold */}
                <path d="M190 104 C205 98 245 98 265 106 C275 110 268 116 250 116 C230 116 200 115 190 108 Z" fill="#E5A93C" stroke="#D4AF37" strokeWidth="2" />
                <line x1="250" y1="108" x2="300" y2="85" stroke="#D4AF37" strokeWidth="1.5" />
                <circle cx="250" cy="108" r="3" fill="#D4AF37" />
                <rect x="295" y="72" width="75" height="22" rx="4" fill="#FFF8E7" stroke="rgba(212,175,55,0.4)" strokeWidth="1" />
                <text x="301" y="87" fontFamily="'Plus Jakarta Sans', sans-serif" fontSize="10" fontWeight="700" fill="#B45309">Cushioning disc</text>

                {/* Condylar Head & Neck (Lower Mandible) */}
                <path d="M205 230 L205 160 C205 130 215 116 230 116 C245 116 255 130 255 160 L255 230 Z" fill="#F8FAFC" stroke="#64748B" strokeWidth="2.5" />
                <circle cx="230" cy="132" r="3.5" fill="#334155" />
                <line x1="205" y1="145" x2="130" y2="145" stroke="#94A3B8" strokeWidth="1.2" />
                <circle cx="205" cy="145" r="3" fill="#64748B" />
                <text x="55" y="149" fontFamily="'Plus Jakarta Sans', sans-serif" fontSize="11" fontWeight="600" fill="#475569">Condylar head</text>

                {/* Lower Jaw (Mandible) Pointer */}
                <line x1="255" y1="195" x2="295" y2="195" stroke="#94A3B8" strokeWidth="1.2" />
                <circle cx="255" cy="195" r="3" fill="#64748B" />
                <text x="302" y="199" fontFamily="'Plus Jakarta Sans', sans-serif" fontSize="11" fontWeight="600" fill="#475569">Mandible bone</text>
              </svg>
            </div>
...
export default BusiestJointSection;
