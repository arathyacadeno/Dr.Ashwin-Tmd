...
export const DisguiseArtistSection = () => {
  return (
    <section className="tmd-disguise-section" id="disguiseArtist">
      <div className="tmd-disguise-container">
        <div className="tmd-disguise-header">
          <h2 className="tmd-section-title">Why the jaw is such a good disguise artist</h2>
        ...
        <div className="tmd-symptoms-grid">
          {symptoms.map((symptom, idx) => (
            <div key={idx} className="tmd-symptom-card">
              <div className="symptom-icon-wrap">{symptom.icon}</div>
              <span className="symptom-tag">{symptom.tag}</span>
...
export default DisguiseArtistSection;
