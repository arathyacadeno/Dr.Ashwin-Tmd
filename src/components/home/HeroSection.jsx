  ...
  return (
    <div className="hero-pinned-track" id="hero" ref={heroRef}>
      <div className="hero-sticky-stage" id="heroStickyStage">
        {/* Video Container: LEFT / EXPANDING */}
        ...
        <div className="hero-figma-main-container" id="heroFigmaStage" ref={figmaStageRef}>
          ...
          {/* Bottom Action Block: Review Stack & Action Buttons */}
          <div className="figma-right-actions-block">
            <div className="figma-primary-cta-col">
              <div className="figma-social-proof-row">
                <div className="figma-avatar-pile">
                  <img src="/assets/images/og image.png" alt="Dr. Ashwin" className="figma-avatar-img" />
                  <img src="/assets/images/outcome_eating.jpg" alt="Patient eating comfortably" className="figma-avatar-img" />
                  <img src="/assets/images/outcome_laughing.jpg" alt="Patient laughing" className="figma-avatar-img" />
                  <img src="/assets/images/hero_smiling_woman.jpg" alt="Patient smiling" className="figma-avatar-img" />
                </div>
            ...
            <a href="#what-is-tmd" className="figma-outline-btn">
              See how we help
            </a>
          </div>
        </div>

        {/* Second Stage: Full-Screen Video with Horizontal Text Scroll Animation */}
