      ...
      <div className="container footer-main-grid">
        ...
        <div className="footer-brand-col">
          <Link to="/" className="footer-brand-badge">
            <img src="/assets/images/logo.png" alt="Dr. Ashwin's TMD Clinic" className="footer-brand-logo-img" />
          ...
          <p className="footer-clinic-desc">
            {clinicInfo?.bio || 'Expert care for TMJ/TMD disorders using advanced diagnostics and non-invasive treatments to restore comfort and jaw function.'}
          </p>
        ...
        <div>
          ...
          <div className="footer-links-col">
            ...
            <Link to="/what-is-tmd">What is TMD</Link>
        ...
        <div>
          ...
          <div className="footer-links-col">
            <Link to="/treatments">Neuromuscular dentistry</Link>
            <Link to="/treatments">TMD diagnosis</Link>
            <Link to="/treatments">Treatment process</Link>
          </div>
        </div>
